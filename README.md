...
> ⚠️ Sistem ini hanya untuk keperluan penelitian/akademik (UAS Machine Learning) dan
> **tidak** menggantikan diagnosis farmasi profesional.
...
**Kesimpulan utama:**
- **EfficientNet-B0** memberikan akurasi tertinggi (**80%**), mengungguli arsitektur lain
  maupun model machine learning klasik (RF/KNN/SVM).
